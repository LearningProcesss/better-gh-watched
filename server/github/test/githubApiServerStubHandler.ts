...
export const userHandler = () => {
    return rest.get('https://api.github.com/user', (req, res, ctx) => {
...
export const subscriptionsHandler = () => {
    return rest.get('https://api.github.com/user/subscriptions', (req, res, ctx) => {
...
export const commitsHandler = () => {
    return rest.get('https://api.github.com/repos/restify/node-restify/commits', (req, res, ctx) => {
...
export const languagesHandler = () => {
    return rest.get('https://api.github.com/repos/restify/node-restify/languages', (req, res, ctx) => {
...
export const rateLimitOkHandler = () => {
    return rest.get('https://api.github.com/rate_limit', (req, res, ctx) => {

        const apiRate = fs.readFileSync(path.join(__dirname, './fixtures/api.github.com.ratelimitOk.json'), 'utf-8')
...
export const rateLimitNotOkHandler = () => {
    return rest.get('https://api.github.com/rate_limit', (req, res, ctx) => {

        const apiRate = fs.readFileSync(path.join(__dirname, './fixtures/api.github.com.ratelimitNotOk.json'), 'utf-8')
